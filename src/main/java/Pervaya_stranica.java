...
public class Pervaya_stranica {
    public static void main(String[] args) {
        ...
        wait.until(ExpectedConditions.invisibilityOfElementLocated(By.xpath("//div[@class='uc-preloader__inner']")));
        driver.findElement(By.xpath("//input[@id='input_13']")).sendKeys("Слуцкая");
        driver.findElement(By.xpath("//input[@id='input_13']")).clear();
        driver.findElement(By.xpath("//input[@id='input_13']")).sendKeys("Иванов");
        wait.until(ExpectedConditions.invisibilityOfElementLocated(By.xpath("//div[@class='uc-preloader__inner']")));
